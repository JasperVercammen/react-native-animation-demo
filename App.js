...
export default class App extends React.Component {
  ...
  render() {
    return (
      <ImageBackground source={require('./background.jpg')} resizeMode='cover' style={{flex: 1, position: 'relative'}}>
        <Image source={require('./rope.png')} resizeMode='contain' style={{position: 'absolute', width: '100%', top: '23%'}} />
